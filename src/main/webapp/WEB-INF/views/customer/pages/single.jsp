...
<html lang="en">
<head>
<title>Spa Care a Beauty and Spa Category Flat bootstrap Responsive website Template | Single-page :: w3layouts</title>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-right">
								<li><a href="index" class="link-kumya"><span data-letters="Home">Home</span></a></li>
								...
								<li><a href="blog" class="link-kumya"><span data-letters="Blog">Blog</span></a></li>		
		...
		<div class="container">			
			<div class="col-md-8 single-page-left">
				<div class="single-agileinfo">
					<img src="${pageContext.request.contextPath}/resources/template/images/g6.jpg" alt=""/>
				...
				<div class="admin-text">
					...
					<div class="admin-w3lsleft">
						<a href="#"><img src="${pageContext.request.contextPath}/resources/template/images/icon2.png" alt=""/></a>
					</div>
				...
				<div class="row related-posts">
					...
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="single.html" class="thumbnail wthree">
							<img src="${pageContext.request.contextPath}/resources/template/images/g1.jpg" alt=""/>
						</a>
						<h5><a href="single.html">Lorem Ipsum is simply</a></h5>
					</div>	
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="single.html" class="thumbnail wthree">
							<img src="${pageContext.request.contextPath}/resources/template/images/g4.jpg" alt=""/>
						</a>
						<h5><a href="single.html">Lorem Ipsum is simply</a></h5>
					</div>
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="single.html" class="thumbnail wthree">
							<img src="${pageContext.request.contextPath}/resources/template/images/g5.jpg" alt=""/>
						</a>
				...
				<div class="response">
					...
					<div class="media response-info">
						<div class="media-left res-agileleft">
							<a href="#">
								<img class="media-object" src="${pageContext.request.contextPath}/resources/template/images/icon2.png" alt=""/>
							</a>
